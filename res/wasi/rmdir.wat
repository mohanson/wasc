(module
  ...
  (import "wasi_unstable" "path_remove_directory" (func $__wasi_path_remove_directory (type 0)))
  ...
  (func $undefined:thread-local_initialization_routine_for_errno (type 7)
    unreachable)
  (func $_start (type 7)
    (local i32)
                    ...
                    block  ;; label = @9
                      block  ;; label = @10
                        ...
                        block  ;; label = @11
                          ...
                          i32.const 0
                          i64.const -1
                          i64.store offset=4060 align=4
                          i32.const 0
                          i64.const 281474976776192
                          i64.store offset=4052 align=4
                          i32.const 0
                          local.get 1
                          i32.const 12
                          i32.add
              ...
              block  ;; label = @6
                block  ;; label = @7
                  block  ;; label = @8
                    ...
                    i32.add
                    i32.const 0
                    i64.load offset=4032 align=4
                    i64.store align=4
                    local.get 8
                    i32.const 0
                    i64.load offset=4024 align=4
  ...
  (func $__wasilibc_populate_preopens (type 7)
    ...
    call $_Exit
    unreachable)
  (func $__wasilibc_rmdirat (type 4) (param i32 i32) (result i32)
    block  ;; label = @1
      local.get 0
      local.get 1
      local.get 1
