(module
  ...
  (import "wasi_unstable" "path_unlink_file" (func $__wasi_path_unlink_file (type 0)))
  ...
  (func $unlink (type 3) (param i32) (result i32)
    ...
    global.set 0
    local.get 2)
  (func $__wasilibc_unlinkat (type 4) (param i32 i32) (result i32)
    block  ;; label = @1
      local.get 0
      local.get 1
      local.get 1
