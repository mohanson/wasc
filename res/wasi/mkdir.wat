(module
  ...
  (import "wasi_unstable" "path_create_directory" (func $__wasi_path_create_directory (type 0)))
  ...
  (func $close (type 3) (param i32) (result i32)
    ...
    i32.store offset=3572
    i32.const -1)
  (func $mkdir (type 4) (param i32 i32) (result i32)
    (local i32 i32)
    global.get 0
    i32.const 16
    i32.sub
