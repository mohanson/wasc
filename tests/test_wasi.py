...
def test_append():
    ...
    subprocess.getoutput('res/wasi_wasc/append /tmp/a')
...
def test_args():
    print('test_args')
    r = subprocess.getoutput('res/wasi_wasc/args 1 2 3').split('\n')
    assert(r[0] == 'argc=4')
    assert(r[2] == 'argv[1]: 1')
    assert(r[3] == 'argv[2]: 2')
    assert(r[4] == 'argv[3]: 3')
    assert(r[5] == 'argv[4]: <null>')
    r = subprocess.getoutput('res/wasi_wasc/args').split('\n')
    assert(r[0] == 'argc=1')
...
def test_cat():
    ...
    r = subprocess.getoutput('res/wasi_wasc/cat /tmp/a')
    assert(r == 'Hello World!')
    r = subprocess.getoutput('res/wasi_wasc/cat /tmp/b')
...
def test_clock():
    print('test_clock')
    r = subprocess.getoutput('res/wasi_wasc/clock').split('\n')
...
def test_exit():
    print('test_exit')
    r, _ = subprocess.getstatusoutput('res/wasi_wasc/exit')
    assert(r == 0)


def test_fd_filestat_set_size():
    print('test_fd_filestat_set_size')
    subprocess.getoutput('res/wasi_wasc/fd_filestat_set_size /tmp/a')
...
def test_fd_filestat_set_times():
    ...
    subprocess.getoutput('echo Hello World! > /tmp/a')
    subprocess.getoutput('res/wasi_wasc/fd_filestat_set_times /tmp/a 100 100')
...
def test_fd_renumber():
    ...
    subprocess.getoutput('res/wasi_wasc/fd_renumber /tmp/a')
    r = subprocess.getoutput('cat /tmp/a')
...
def test_largefile():
    ...
    r = subprocess.getoutput('res/wasi_wasc/largefile /tmp/a').split('\n')
...
def test_ls():
    print('test_ls')
    subprocess.getoutput('res/wasi_wasc/ls /tmp/').split('\n')


def test_mkdir():
    print('test_mkdir')
    subprocess.getoutput('res/wasi_wasc/mkdir /tmp/a')
    assert(os.path.exists('/tmp/a'))
    subprocess.getoutput('res/wasi_wasc/mkdir /tmp/a/b')
...
def test_preadwrite():
    ...
    r = subprocess.getoutput('res/wasi_wasc/preadwrite /tmp/a').split('\n')
...
def test_random():
    print('test_random')
    r = subprocess.getoutput('res/wasi_wasc/random')
...
def test_rm():
    print('test_rm')
    subprocess.getoutput('echo Hello World! > /tmp/a')
    subprocess.getoutput('res/wasi_wasc/rm /tmp/a')
...
def test_stat():
    print('test_stat')
    subprocess.getoutput('echo Hello World! > /tmp/a')
    subprocess.getoutput('res/wasi_wasc/stat /tmp/a')
    subprocess.getoutput('rm /tmp/a')


def test_stdout():
    print('test_stdout')
    r = subprocess.getoutput('res/wasi_wasc/stdout')
    assert(r == 'Hello world!')


def test_write():
    print('test_write')
    subprocess.getoutput('res/wasi_wasc/write /tmp/a')
    r = subprocess.getoutput('cat /tmp/a')
    assert(r == 'Hello World!')
    subprocess.getoutput('rm /tmp/a')
